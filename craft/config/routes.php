...
return [
    ...
    'news/category/(?P<category>(.*))' => 'news/index',

    // news archive
    'news/archive' => 'news/index',
    'news/archive/(?P<archiveYear>\d{4})' => 'news/index',

    // blog category
    'blog/category' => 'blog/index',
    'blog/category/(?P<category>(.*))' => 'blog/index',

    // blog archive
    'blog/archive' => 'blog/index',
    'blog/archive/(?P<archiveYear>\d{4})' => 'blog/index',

    // attorney vcard download
    'attorneys/(?P<attorney>(.*))/vcard' => 'attorneys/_vcard.vcf',

    // Search results
    'search' => '_main/search',
    'search/results' => '_main/search',

    // sitemap
    // 'sitemap' => '_main/sitemap.xml',
    'sitemap.xml' => '_main/sitemap.xml',

    // misc
    'news/anuj-sud-joins-the-firm-as-an-associate' => ['action' => 'pD/anujSud']
