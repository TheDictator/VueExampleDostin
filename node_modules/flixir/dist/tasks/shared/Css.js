...
exports.default = function (options) {
    ...
    return _gulp2.default.src(options.src.path).pipe($.if(config.sourcemaps, $.sourcemaps.init())).pipe($.cssGlobbing({ extensions: ['.scss'] })).pipe(options.compiler(options.pluginOptions)).on('error', function (e) {
