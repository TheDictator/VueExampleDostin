...
var publicPath = _2.default.config.publicPath;
var fs = void 0;
var del = void 0;
var glob = void 0;
var gulp = void 0;
...
_2.default.extend('version', function (src, buildPath) {
    var paths = prepGulpPaths(src, buildPath);

    loadPlugins();

    new _2.default.Task('version', function () {
...
function prepGulpPaths(src, buildPath) {
    ...
    buildPath = buildPath || _2.default.config.get('public.versioning.buildFolder');

    var paths = new _2.default.GulpPaths().src(src, _2.default.config.publicPath).output(buildPath);
