...
exports.default = function (flixir) {
...
var Task = function () {
    ...
    _createClass(Task, [{
        ...
        value: function run() {
            ...
            return this.definition(_gulp2.default, Flixir.Plugins);
        }
        ...
        value: function log(src, output) {
            ...
            Flixir.Log.heading("Fetching " + task + " Source Files...").files(src.path ? src.path : src, true);

            if (output) {
                Flixir.Log.heading('Saving To...').files(output.path ? output.path : output);
            }
        }
        ...
        value: function toGulp() {
            ...
            _gulp2.default.task(name, function () {
                if (shouldRunAllTasksWithName(name)) {
                    return Flixir.tasks.byName(name).forEach(function (task) {
                        return task.run();
                    });
                }
